...
async function sysStatGetAll() {
    ...
    return new Promise(async(res, rej) => {
        ...
        .then(async() => {await sysStatGet(["BUF", "BUFPOOL", "TIMER", "TCPMSG", "TCPSEG", "TCPLSTN"])})
        .then(async() => {await sysStatGet(["TCPPCB", "REASDATA", "NETCONN", "NETBUF", "IGMP", "FRAGBUF"])})
        .then(async() => {await sysStatGet(["ALTCPPCB", "UDPPCB"])})
        .then(() => {
            res();
        }).catch((m) => {
            rej(m);
...
{
    let req = {Cmd:"SysSvcStateGet", SessionId:sIdG(), "SvcNames":sn};
...
async function sysSvcStateGetAll() {
    return new Promise(async(res, rej) => {
        ...
        .then(async() => {await sysSvcStateGet(["JSON", "FRM", "FTP", "HTTP", "MQTT", "MBUS"])})
        .then(() => {
            res();
        }).catch((m) => {
            rej(m);
